...
public class BreTreatyReinsurerInfoDto  {
    ...
    public String getCountryOfReinsurer() {
        return this.countryOfReinsurer;
    }
    ...
    public String getCountryOfPlacementBroker() {
        return this.countryOfPlacementBroker;
    }
    ...
    public String getBreBrokeragePercent() {
        return this.breBrokeragePercent;
    }
    ...
    public String getIncludingExcludingBrokerageVat() {
        return this.includingExcludingBrokerageVat;
    }
    ...
    public String getConditionReinsurer() {
        return this.conditionReinsurer;
    }
